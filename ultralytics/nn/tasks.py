...
from .modules.Slim_neck import VoVGSCSP, GSConv
from .modules.InceptionWT import InceptionNeXt
from .modules.CloWT1 import Attnbllock
from .modules.CloWT2 import EfficientAttention
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            SCDown,
            C2fCIB,
            WTConv2d,VoVGSCSP, GSConv,Attnbllock,EfficientAttention,InceptionNeXt,
        }:
            c1, c2 = ch[f], args[0]
