...
parser.add_argument('--root_dir', default=r'E:\YSH\yolo\data_best\val_coco', type=str,
...
def train_test_val_split_random(img_paths, ratio_train=0.7, ratio_test=0.2, ratio_val=0.1):
    # 这里可以修改数据集划分的比例。
