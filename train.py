...
parser.add_argument('--hyp', type=str, default='E:/yolo/v8/ultralytics-8.2.87/my.yaml', help='size of each image batch')
parser.add_argument('--model', type=str, default='E:/yolo/v8/ultralytics-8.2.87/models/yolov8_Clo2_Slim2.yaml', help='pretrained weights or model.config path')
